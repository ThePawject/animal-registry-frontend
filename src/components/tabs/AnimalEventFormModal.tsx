...
import { Calendar, FileText, User, XIcon } from 'lucide-react'
...
export default function AnimalEventFormModal({
  ...
  const isEdit = !!event
  const { mutateAsync: addEvent, isPending: isAdding } = useAddAnimalEvent()
  const { mutateAsync: editEvent, isPending: isEditing } = useEditAnimalEvent()
                  ...
                  return (
                    ...
                    >
                      <Input
                        ...
                        id="Wykonane przez"
                        className="bg-background"
                        placeholder="Wpisz kto wykonał czynność"
                      />
                    </FormField>
                  )
                }}
