...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-6Ca7zYk2.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-Do32kaGe.js");
...
const ROUTER_BASEPATH = "animal-registry-frontend";
const SERVER_FN_BASE = "/animal-registry-frontend/_serverFn/";
